...
def print_times(v, L):
    ...
    binary_time = time_it(bs.binary_search, v, L)

    print("value=%d\t basic_time=%.02f\t for_time=%.02f\t sentinel_time=%.02f\t index_time=%.02f\t binary_time=%.02f"
          % (v, basic_time, for_time, sentinel_time, index_time, binary_time))
